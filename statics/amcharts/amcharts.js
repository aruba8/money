...
AmCharts.Cuboid = AmCharts.Class({construct: function (a, b, c, d, e, f, g, h, k, l, m, n, r) {
    this.set = a.set();
    this.container = a;
    this.h = Math.round(c);
    this.w = Math.round(b);
...
AmCharts.RecItem = AmCharts.Class({construct: function (a, b, c, d, e, f, g, h, k) {
    b = Math.round(b);
    void 0 == c && (c = "");
    k || (k = 0);
    void 0 == d && (d = !0);
...
AmCharts.RadItem = AmCharts.Class({construct: function (a, b, c, d, e, f, g) {
    ...
    if (1 == e && 0 < w && !g) {
        ...
        } else z = AmCharts.wedge(m, 0, 0, 0, -360, b, b, g, 0, {fill: u, "fill-opacity": w, stroke: 0, "stroke-opacity": 0, "stroke-width": 0});
        d.push(z);
        z.translate(f, H)
    }
    !1 === a.visible &&
...
AmCharts.RadarFill = AmCharts.Class({construct: function (a, b, c, d) {
    ...
    } else this.fill = AmCharts.wedge(c, 0, 0, h, d - h, e, e, b, 0, {fill: g, "fill-opacity": f, stroke: 0, "stroke-opacity": 0, "stroke-width": 0});
...
AmCharts.AmGraph = AmCharts.Class({construct: function () {
    ...
    createRadarGraph: function () {
        ...
        this.chart.hideBalloon();
        a && (a = {type: "rollOutGraphItem", item: a, index: a.index, graph: this, target: this, chart: this.chart}, this.fire("rollOutGraphItem",
        ...
        a && (a = {type: "rightClickGraphItem",
            item: a, index: a.index, graph: this, target: this, chart: this.chart}, this.fire("rightClickGraphItem", a), this.chart.fire("rightClickGraphItem", a))
    ...
    if (this.enabled) {
        ...
        if (r) {
            ...
            if (c.mouseIsOver || A || z || this.forceShow)if (this.forceShow = !1, z) {
                ...
                0 !== d && (g = {type: "zoomed", target: this}, g.chart = this.chart, f.parseDates && !f.equalSpacing ? (c + d > w && (d = w - c), A + d < u && (d =
                ...
                if (G && this.valueBalloonsEnabled && u && c.balloon.enabled) {
                    ...
                    for (f = 0; f < G.length; f++)if (t = G[f], (!this.oneBalloonOnly || t == O) && (t.showBalloon && !t.hidden && t.balloonText) && (v = r.axes[t.valueAxis.id].graphs[t.id], w = v.y, !isNaN(w))) {
                        ...
                        q && (q = t.valueBalloon, x = c.getBalloonColor(t, v), q.setBounds(k, l, k + m, l + n), q.pointerOrientation = "H", q.changeColor(x), void 0 !== t.balloonAlpha && (q.fillAlpha = t.balloonAlpha), void 0 !== t.balloonTextColor && (q.color = t.balloonTextColor),
                            q.setPosition(h + k, p + l), t = c.formatString(t.balloonText, v, t), "" !== t && q.showBalloon(t), !s && q.set && q.set.hide(), u.push({yy: w, balloon: q}))
                    }
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    -359.94 > s && (s = -359.94);
    e <= s && (e = s);
    var q = 1 / 180 * Math.PI, s = b + Math.cos(d * q) * h, t = c + Math.sin(-d * q) * r, v = b + Math.cos(d * q) * f, u = c + Math.sin(-d * q) * g, w = b + Math.cos((d + e) * q) * f, y = c + Math.sin((-d - e) * q) * g, x = b + Math.cos((d + e) * q) * h, q = c + Math.sin((-d - e) * q) * r, A = {fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0}, z = 0;
    180 < Math.abs(e) && (z = 1);
    d = a.set();
    var G;
    ...
    if (AmCharts.ifArray(b)) {
        if (0 < a.realWidth && 0 < a.realHeight) {
            ...
            for (m = 0; m < b.length; m++)if (e = b[m], !0 !== e.hidden && 0 < e.percents) {
                var k = 360 * -e.percents / 100, q = Math.cos((f + k / 2) / 180 * Math.PI), t = Math.sin((-f - k / 2) / 180 * Math.PI) * (l / p), h = {fill: e.color, stroke: a.outlineColor, "stroke-width": a.outlineThickness, "stroke-opacity": a.outlineAlpha};
